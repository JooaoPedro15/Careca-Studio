...
const MARCA_ITEM = {
  ...
  properties: {
    ...
    plano_parceria: {
      ...
      properties: {
        produto_ou_jogo: { type: 'STRING' },
        gancho_lancamento: { type: 'STRING' },
        proposta_ativacao: { type: 'STRING' },
        formatos_entregaveis: { type: 'ARRAY', items: { type: 'STRING' } },
        periodo_ideal: { type: 'STRING' },
        ideia_de_video: { type: 'STRING' },
        porque_faz_sentido: { type: 'STRING' },
      },
    },
    contato: {
      type: 'OBJECT',
